...
$qry=mysqli_query($connect,"select * from sat_user where uname='$uname' && pass='$pass'");
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="login_auth.php">Data Controller</a> </li>
                     </ul>
                   </nav>
                 </div>
               </div> 
              ...
              <div class="carousel-caption">
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>SatChain</h1>
                      <p>GEO Network Security Mechanism based on Blockchain and QKD Protocol</p>
                      <a href="#">Read more</a><a href="#">get a qoute</a>
                    </div>
                  </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          ...
          <form class="contact_bg">
            <div class="row">
              <div class="col-md-12">
                <div class="titlepage">
                  <h2>User <strong class="yellow">Login</strong></h2>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                 <button class="send" name="btn" type="submit">Login</button>
                </div>
              </div>
            </form>
          </div>
