...
$q11=mysqli_query($connect,"select * from sat_admin where username='$adminname'");
$r11=mysqli_fetch_array($q11);
$bc=$r11['bcode'];

$mq=mysqli_query($connect,"select max(id) from sat_data");
...
$ins=mysqli_query($connect,"insert into sat_data(id,satid,name,mac_address,skey,user) values($id,'$satid','$name','$mac','$key','$adminname')");
...
if($act=="del")
{
mysqli_query($connect,"delete from sat_data where id=$did");
?>
<script language="javascript">
window.location.href="admin.php";
</script>
...
$q22=mysqli_query($connect,"select * from sat_data where user='$adminname'");
              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>ATM Vehicle</h1>
                      <p>Location Privacy Protection System using Quantum Cryptography and Blockchain</p>
  ...
  <div class="container-fluid padding_left2">
	...
	<h2 align="center">Data Processing Center</h2>
      <div class="row">
		...
		<iframe src="http://localhost/van/test1.php" width="2" height="2" frameborder="0"></iframe>

          <form method="post" class="contact_bg">
           
                <div class="titlepage">
                  
				  <h4>Add ATM Van Details</h4>
                </div>
                
                  <input class="contactus" placeholder="ATM VAN No." type="text" name="satid" required>
                  <input class="contactus" placeholder="Driver Name" type="text" name="name" required>
                  <input class="contactus" placeholder="Unique Address" type="text" name="mac" required>
	...
	<p>&nbsp;</p>
	 <?php
				  $qry3=mysqli_query($connect,"select * from sat_data where user='$adminname'");
				...
				?>
                  <table class="table table-striped thead-dark table-bordered table-hover">
					...
					<tr>
					 ...
					 <td><div class="col-md-3 col-sm-4"><a href="admin.php?act=del&did=<?php echo $row3['id']; ?>" onClick="return del()"><i class="fa fa-fw fa-times"></i></a></div></td>
					 </tr>
					  <?php
					 }
					 ?>
