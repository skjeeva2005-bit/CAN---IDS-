...
$qry=mysqli_query($connect,"select * from sat_admin where uname2='$uname' && pass2='$pass'");
...
<body class="main-layout">
  <!-- loader  -->
  <!--<div class="loader_bg">
    <div class="loader">ATM Vehicle</div>
  </div>-->
  <!-- end loader -->
  <!-- header -->
  <header>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li class="active"> <a href="login_auth.php">Trust Authority</a> </li>
                     </ul>
                   </nav>
                 </div>
               </div> 
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          ...
          <form class="contact_bg" method="post">
            <div class="row">
              <div class="col-md-12">
                <div class="titlepage">
                  <h2>Trusted <strong class="yellow">Authority</strong></h2>
                </div>
                <div class="col-md-12">
