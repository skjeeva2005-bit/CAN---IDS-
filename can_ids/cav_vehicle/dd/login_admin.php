...
$qry=mysqli_query($connect,"select * from sat_admin where username='$uname' && password='$pass' && utype='user'");
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li class="active"> <a href="login_admin.php">Data Center </a> </li>
...
<div id="contact" class="contact">
  <div class="container-fluid padding_left2">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          ...
          <form class="contact_bg" method="post">
            <div class="row">
              <div class="col-md-12">
                <div>
                  <h4 style="color:#003399">Data Processing Center</h4>
                </div>
                <div class="col-md-12">
	...
	<iframe src="receive.php" width="10" height="10" frameborder="0"></iframe>
