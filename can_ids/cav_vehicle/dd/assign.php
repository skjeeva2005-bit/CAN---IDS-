...
if(isset($btn))
{
	...
	mysqli_query($connect,"update sat_user set satid='$satid' where uname='$user'");
        ...
        <div class="col-md-8">
          ...
          <form method="post" class="contact_bg">
				...
				?>
				  ...
				  <?php
				  $cq=mysqli_query($connect,"select * from sat_data where user='$adminname'");
				  while($cr=mysqli_fetch_array($cq))
				  {
				  ?>
				 <input type="radio" name="satid" value="<?php echo $cr['satid']; ?>"> <?php echo $cr['satid']." - ".$cr['name']; ?><br>
				  <?php
				  }
				  ?>
				 </select>
                
              <div align="left">    <input class="send" type="submit" name="btn" value="Assign"></div>
