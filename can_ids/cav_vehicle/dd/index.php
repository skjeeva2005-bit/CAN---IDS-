            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html">ATM Vehicle</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="login_admin.php">Data Center </a> </li>
                      <li> <a href="login_auth.php">Trust Authority</a> </li>
                     </ul>
                   </nav>
                 </div>
               </div> 
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>QKD <strong class="yellow">ATM Vehicle</strong></h2>
          <p> The sixth generation (6G) networks are expected to provide a fully connected world with terrestrial wireless and satellite communications integration.Due to satellite physical constraints in terms of available power and area, data processing capacity is low, storage and security are limited such that the data may be vulnerable to tampering or contamination by attackers. Since satellite communication has been more and more important in developing global communication networks, there have been concerns about the security in satellite communication.  </p>
          <a href="Javascript:void(0)">Read more</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <figure><img src="images/atmvan.jpg" alt="#" /></figure>
        </div>
      </div>
    </div>
		...
		?>
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="titlepage">
                  <h2>Bank <strong class="yellow">Control Center</strong></h2>
                </div>
                <div class="col-md-12">
                  <input class="contactus" placeholder="User Name" type="text" name="uname">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <input class="send" type="submit" name="btn" value="Login">
                </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
              ...
              <div class="copyright">
                <div class="container">
                  <p>ATM Vehicle <a href="https://html.design/"> </a></p>
                </div>
              </div>
            </div>
          </footr>
